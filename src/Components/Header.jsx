    ...
    <nav className="border-gray-200 pb-2 bg-gradient-to-r from-orange-200 via-[#f7f5db] to-green-200 overflow-hidden">
      <div className="max-w-screen px-1 sm:px-8 flex flex-wrap items-center justify-between">
        ...
        <button
          ...
          aria-expanded="false"
        >
          <svg className="w-3 h-3 sm:w-6 sm:h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd"></path>
          </svg>
        </button>
        <div className={getHamBurgerStyle()} id="navbar-dropdown" ref={targetRefDropDown}>

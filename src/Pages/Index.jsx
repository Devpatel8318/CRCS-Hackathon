...
function Index() {
  return (
    <div className='w-full grid lg:grid-cols-10 bg-gradient-to-r   from-orange-100 via-white to-green-100'>
      ...
      <div className='m-4 text-gray-800 font-medium lg:col-span-6 text-lg pr-6 flex justify-center items-center flex-col'>
        <h1 className='font-poppins font-bold text-orange-500 text-2xl text-center mb-6 uppercase'>Central Registrar of Cooperative Societies office</h1>
